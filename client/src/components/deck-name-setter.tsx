...
export function DeckNameSetter() {
  ...
  return <>
    <div className="flex items-baseline border-b mb-2 pb-2 border-zinc-200 gap-4 px-2">
      <label htmlFor="deck-name" className="text-zinc-700">Deck Name</label>
      <input
        id="deck-name"
        type="text"
        value={deckName}
    ...
    <div className="flex items-center justify-between gap-4">
      <p className="text-xs text-zinc-500 max-w-60">When set, new cards will be created with a "deck" tag with this value and cards will be automatically filtered.</p>
      <Link
