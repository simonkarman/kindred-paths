...
export const CardTypesInput = (props: {
  ...
  return <div className="space-y-1">
    <label htmlFor="cardTypes" className="block font-medium text-zinc-800">
      Card Type <span className="text-xs text-zinc-500 italic">(hold Ctrl or Cmd to select multiple)</span>
    </label>
    <select
      id="cardTypes"
      className="w-full bg-white h-31 px-1 py-0.5 border border-zinc-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      multiple
      value={props.types}
      onChange={(e) => {
