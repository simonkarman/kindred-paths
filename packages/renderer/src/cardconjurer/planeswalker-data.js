 ...
 * @returns {{ size: 'regular'|'tall', rulesFontSize: number, abilities: Array<{ cost: string, content: string, height: number, startHeight: number }> } | undefined}
 */
export function computePlaneswalkerData(renderable) {
